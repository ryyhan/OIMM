...
dataset_name = st.sidebar.selectbox("Select a Dataset",("Iris","Breast Cancer","Wine Dataset","Titanic Dataset"))
...
def get_classifier(clf_name,params):
    if clf_name == "KNN":
        ...
        model=RandomForestClassifier(max_depth=params["max_depth"],n_estimators=params["n_estimators"],random_state=42)
    return model
